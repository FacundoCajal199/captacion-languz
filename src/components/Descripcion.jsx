  ...
  return (
    ...
    <h1 className="text-center style-titulos">EVENTO DISPONIBLE POR ÚNICA VEZ</h1>
      ...
      te avisaremos en tiempo real cuando se estrenen
        ...
        Por tal motivo hemos creado un grupo de WhatsApp, en donde te enviaremos el link de cada entrenamiento unos minutos antes de su estreno, además contenido e información muy importante
        <br />
        <br />
