  ...
  return (
    ...
    <h2 className="text-center h1">EVENTO DISPONIBLE POR ÚNICA VEZ</h2>
      ...
      te avisaremos en tiempo real cuando se estrenen
        ...
        Por tal motivo hemos creado un grupo de WhatsApp, en donde te enviaremos el link de cada entrenamiento unos minutos antes de su estreno, además contenido e información muy importante, en este grupo solo escribirá el administrador y no vas a recibir spam.
        <br />
        <br />
